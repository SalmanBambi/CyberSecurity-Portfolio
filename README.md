...
| **Network Architecture & Security** | Analyzing network structure, protocols, and firewall rules. | Completed | [View Incident Report](./NIST_CSF_Incident_Response_Report.pdf) |
